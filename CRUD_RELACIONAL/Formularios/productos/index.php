...
<body>
    ...
    <div class="container-lg mt-5">
        ...
        <h1 class="text-center bg-danger text-light ">Formulario Producto</h1>
            ...
            <table class="table table-hover">
                <thead class="table-dark">
                    <tr>
                        ...
                        <th scope="col">dimensiones del producto</th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <th scope="row"><?php echo $resultado['dimensiones_producto'] ?></th>
                            <th scope="row"><?php echo $resultado['marca'] ?></th>
                            <th scope="row"><?php echo $resultado['num_serie'] ?></th>
                            <th scope="row"><?php echo $resultado['lugar_creacion'] ?></th>
                            <th scope="row">
                                <a href="<?php echo base_url; ?>Formularios/productos/actualizar.php?Id=<?php echo $resultado['id'] ?>" class="btn btn-outline-warning">
